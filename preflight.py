...
def main() -> None:
    ...
    required_routes = {
        ...
        ("GET", "/customer-portal/service-plans"),
        ("GET", "/customer-portal/payments"),
        ("POST", "/customer-portal/payments/quote"),
        ...
        ("GET", "/organization/plan-activations"),
        ("GET", "/organization/plan-activations/{payment_id}"),
        ("POST", "/organization/plan-activations/{payment_id}/activate"),
        ("POST", "/organization/plan-activations/{payment_id}/resolve-duplicates"),
